...
2. Identify the project name. Check in order: what the user said, the repo/solution/package
   name (`.sln`, `package.json`, `pyproject.toml`, …), the README title, project docs.
...
4. If the project is not found, try `mindvault_search` with one to three likely name variants
